	...
	public static void readFlatFile(String fileURL, String delimiter)
	{
		try {
			...
			while(scan.hasNextLine() == true)
			{
				...
				if(numLines == -1)
				{
					numCategories = fileData.split(",").length;
				}
				numLines++;
			}
